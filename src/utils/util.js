...
util.imgUrlRectify = function(placeholderUrl) {
	return placeholderUrl.replace(
		new RegExp(Config.IMG_SERVER_URL_PLACEHOLDER, "gm"),
		Config.IMG_SERVER_URL
	);
};
/**
 ...
 * @returns {*}
 */
util.imgUrlRectifyFallback = function(placeholderUrl) {
	return placeholderUrl.replace(
		new RegExp(util.getSettingCache("ImageServerUrl"), "gm"),
		Config.IMG_SERVER_URL_PLACEHOLDER
	);
};
export default util;
